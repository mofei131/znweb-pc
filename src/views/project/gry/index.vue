...
<!--      <el-table-column type="selection" width="55" align="center" />-->
      ...
      <el-table-column label="付款状态" align="center" prop="zzpayState" :formatter="aapaystateFormat" />
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="货值单价(元)" prop="valuePrice">
              <el-input v-model="form.valuePrice" placeholder="请输入货值单价" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="货值总价(元)" prop="valueTprice">
              <el-input v-model="form.valueTprice" placeholder="请输入货值总价" />
            </el-form-item>
          </el-col>
        </el-row>
<!--        图片上传-->
      ...
      <div slot="footer" class="dialog-footer">
        <el-button v-if="isLook!=3" type="primary" @click="submitForm">确 定</el-button>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listGry(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('project/gry/export', {
        ...this.queryParams
      }, `project_gry.xlsx`)
    },
    ...
    jsjc(){
      ...
      if(this.form.gryRz!=null && this.form.gryRz!='' || this.form.gryRz==0){
