        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="成立日期:" prop="setupTime">
              <el-date-picker clearable size="small" v-if="!editForm" style="width: 100%;"
...
<script>
import { listTerminal, getTerminal, delTerminal, addTerminal, updateTerminal } from "@/api/project/terminal";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('project/terminal/export', {
        ...this.queryParams
