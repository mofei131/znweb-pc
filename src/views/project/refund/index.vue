<template>
  <div class="app-container">
    ...
    <el-dialog title="打印预览" :visible.sync="printReviewVisible" @close="onPrintReviewClose" width="80%">
      <div class="print-div" id="print_area_19">
        <div class="search-title-content">
          ...
          <!--审批流程-->
          <approval-print :typeId="19" :stId="apyamentId" :approveHisListd="approveHisList"
...
export default {
  ...
  methods: {
    ...
    // 打印
    async resolveImg() {
      let imgBase64 = await this.getImage("print_area_19");
      printJS({
        printable: imgBase64,
        type: "image",
        header: null,
