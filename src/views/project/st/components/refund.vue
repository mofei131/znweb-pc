    ...
    <div class="app-container">
        <!-- <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="项目编号" prop="stId">
                <el-input v-model="queryParams.stId" placeholder="请输入项目编号" clearable size="small"
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="项目名称" prop="stName">
                <el-input v-model="queryParams.stName" placeholder="请输入项目名称" clearable size="small"
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="附件">
                            <el-upload :action="url" :headers="headers" :on-preview="handlePreview"
        ...
        <el-dialog :title="detailTitle" :visible.sync="detailOpen" width="960px" append-to-body>
            ...
            <el-table v-loading="detailLoading" :data="detailList">
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.state == '0'" size="mini" type="text"
                            @click="getUpdateDetail(scope.row)" v-hasPermi="['project:refund:edit']">修改</el-button>
                        <el-button v-if="scope.row.state == '0'" size="mini" type="text"
                            @click="updateFinish(scope.row)" v-hasPermi="['project:refund:query']">完成</el-button>
