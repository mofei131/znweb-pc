                ...
                <div v-if="isLook != 4">
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="收款方式" prop="skWay">
                                    <el-select v-model="form.skWay" @change="toggleSelection" placeholder="请选择收款方式"
                                        style="width: 100%">
                            ...
                            <el-row>
                                <el-col :span="12">
                                    <el-form-item label="热值单价(元/Kcal)" prop="rzPrice">
                                        <el-input v-model="form.rzPrice" @change="toggleSelection"
                                            placeholder="请输入热值单价(元/Kcal)" />
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        </div>
                    ...
                    <div v-if="this.form.skType == '预收款'">
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="收款日期" prop="skTime">
                                    <el-date-picker clearable size="small" style="width: 100%" v-model="form.skTime"
                                        type="date" value-format="yyyy-MM-dd" placeholder="选择收款日期">
                                    </el-date-picker>
                                </el-form-item>
                            </el-col>
                        </el-row>
...
export default {
    ...
    methods: {
        ...
        async handlePrint(row) {
            ...
            await getApprovalProcessList("6", row.skId).then((res) => {
