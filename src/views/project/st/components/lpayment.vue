        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                    v-hasPermi="['project:lpayment:add']">新增</el-button>
            </el-col>
            <!--      <el-col :span="1.5">-->
            <!--        <el-button-->
            <!--          type="success"-->
            ...
            <!-- <el-col :span="1.5">
                <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
                    v-hasPermi="['project:lpayment:export']">导出</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="lpaymentList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" width="160" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    ...
                    <el-button v-if="
                        scope.row.state == '3' && scope.row.outPrice < scope.row.tntPrice
                    ...
                    <el-button v-if="scope.row.state == '3' && scope.row.fkState == '未付款'" size="mini" type="text"
                        icon="el-icon-edit" @click="handleUpdateFkState(scope.row)"
                        v-hasPermi="['project:lpayment:edit']">付款</el-button>
                    <el-button v-if="
                        scope.row.state == '3' &&
            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="150px">
                <div v-if="isLook != 4 && isLook != 5">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="第三方公司" prop="tpcId">
                                <el-select filterable value-key="stId" @change="changeTpc" v-model="form.tpcId"
                                    placeholder="请选择第三方公司" style="width: 100%">
                                    <el-option v-for="obj in tpcOptions" :key="obj.tpcId" :label="obj.name"
                                        :value="obj.tpcId"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <div v-if="false" style="margin-bottom: 30px">
                        <el-row>
                            <el-col :span="24">
                                <el-table ref="wlsingleTable" :data="form.wldetailsList" :key="tableUpdate"
                                    style="width: 100%">
                                    ...
                                    <el-table-column label="税率">
                                        <template slot-scope="scope">
                                            <el-form-item label-width="0"
                                                :prop="'wldetailsList.' + scope.$index + '.tax'" :rules="rules.tax">
                        ...
                        <el-col :span="12">
                            <el-form-item label="回款日期" prop="outTime">
                                <el-date-picker clearable size="small" style="width: 100%" v-model="form.outTime"
                                    type="date" value-format="yyyy-MM-dd" placeholder="选择回款日期">
                                </el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
...
export default {
    ...
    methods: {
        ...
        async handlePrint(row) {
            ...
            await getProcessDataByStId("9", row.lpaymentId).then((res) => {
