    ...
    <div class="app-container">
        <!-- <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="项目名称" prop="stName">
                <el-input v-model="queryParams.stName" placeholder="项目名称" clearable size="small"
        ...
        <el-table v-loading="loading" :data="bidApplyList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button v-if="!scope.row.state || scope.row.state == '4'" size="mini" type="text"
                        icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['project:bidApply:edit']">修改
                    </el-button>
                    ...
                    <el-col :span="12">
                        <el-form-item label="单价模式" prop="unitPriceMode">
                            <el-radio-group v-model="form.unitPriceMode">
                                <el-radio v-for="(item, index) in unitPriceModeOptions" :key="index" :label="item.key">
                                    {{ item.label }}</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </el-col>
