                    ...
                    <el-col :span="12">
                        <el-form-item label="第三方公司" prop="tpcId">
                            <el-select filterable value-key="stId" @change="changeTpc" v-model="form.tpcId"
                                ...
                                <el-option v-for="obj in tpcOptions" :key="obj.tpcId" :label="obj.name" :value="obj">
                                </el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="12">
                        <el-form-item label="收票日期" prop="sticketTime">
                            <el-date-picker clearable size="small" style="width: 100%" v-model="form.sticketTime"
                                type="date" value-format="yyyy-MM-dd" placeholder="选择收票日期">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
                        ...
                        <el-col :span="24">
                            <el-table ref="wlsingleTable" :data="form.wldetailsList" :key="tableUpdate"
                                ...
                                <el-table-column label="费用名称">
                                    <template slot-scope="scope">
                                        <el-form-item label-width="0"
                                            :prop="'wldetailsList.' + scope.$index + '.wlType'" :rules="rules.wlType">
                                ...
                                <el-table-column label="税率">
                                    <template slot-scope="scope">
                                        <el-form-item label-width="0" :prop="'wldetailsList.' + scope.$index + '.tax'"
                                            :rules="rules.tax">
