            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData1" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData1.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData2" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData2.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                                    <el-select v-model="scope.row.s1">
                                        <el-option label=">" value=">" />
                                        <el-option label="<" value="<" />
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData3" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData3.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                                    <el-select v-model="scope.row.s1">
                                        <el-option label=">" value=">" />
                                        <el-option label="<" value="<" />
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData4" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData4.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                                    <el-select v-model="scope.row.s1">
                                        <el-option label=">" value=">" />
                                        <el-option label="<" value="<" />
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData5" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData5.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                                    <el-select v-model="scope.row.s1">
                                        <el-option label=">" value=">" />
                                        <el-option label="<" value="<" />
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData6" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData6.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                                    <el-select v-model="scope.row.s1">
                                        <el-option label=">" value=">" />
                                        <el-option label="<" value="<" />
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData7" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData7.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                                    <el-select v-model="scope.row.s1">
                                        <el-option label=">" value=">" />
                                        <el-option label="<" value="<" />
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData8" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData8.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                                    <el-select v-model="scope.row.s1">
                                        <el-option label=">" value=">" />
                                        <el-option label="<" value="<" />
                ...
                <div style="margin-bottom: 30px">
                    <el-table :show-header="false" ref="singleTable" :data="form.tableData9" style="width: 100%">
                        ...
                        <el-table-column label="符号">
                            <template slot-scope="scope">
                                <el-form-item label-width="0" :prop="'tableData9.' + scope.$index + '.s1'"
                                    :rules="rules.s1">
                                    <el-select v-model="scope.row.s1">
                                        <el-option label=">" value=">" />
                                        <el-option label="<" value="<" />
    ...
    data() {
        return {
            ...
            rules: {
                ...
                a2: [{ required: true, message: "请输入", trigger: "blur" }],
                s2: [{ required: true, message: "请选择", trigger: "blur" }],
                b1: [{ required: true, message: "请输入", trigger: "blur" }],
                s3: [{ required: true, message: "请选择项目", trigger: "blur" }],
