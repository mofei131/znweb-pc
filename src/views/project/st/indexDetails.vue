...
<!--      <el-table-column label="项目id" align="center" prop="stId" />-->
      ...
      <el-table-column label="结项时间" align="center" prop="xmTime" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作"   width="160" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          >查看</el-button>
          <el-button
            v-if="scope.row.xmState=='1' && scope.row.xmState!='0'"
            size="mini"
            type="text"
            icon="el-icon-edit"
          ...
          >异常</el-button>
          <el-button
            v-if="scope.row.xmState=='2'  && scope.row.xmState!='0'"
            size="mini"
            type="text"
            icon="el-icon-edit"
