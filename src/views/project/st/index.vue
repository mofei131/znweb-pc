...
<!--      <el-table-column label="项目id" align="center" prop="stId" />-->
      ...
      <el-table-column label="审核状态" :formatter="statusFormat" align="center" prop="state" />
          ...
          <el-row>
            ...
            <el-col :span="3" >
                <el-form-item label="" prop="settlementPA1"  label-width="10px">
                  <span><el-input v-model="form.settlementPA1" placeholder="" style="width: 80%"/></span><span>%</span>
                </el-form-item>
            </el-col>
              <el-col :span="3" >
                <el-form-item label="" prop="settlementPA2"  label-width="10px">
                  <span><el-input v-model="form.settlementPA2" placeholder="" style="width: 80%"/></span><span>%</span>
                </el-form-item>
              </el-col>
              <el-col :span="3" >
                <el-form-item label="" prop="settlementPA3"  label-width="10px">
                  <span><el-input v-model="form.settlementPA3" placeholder="" style="width: 80%"/></span><span>%</span>
                </el-form-item>
              </el-col>
            </div>
          </el-row>
          ...
          <el-row>
            <el-col :span="12">
              <div v-if="form.marginType=='1'">
                <el-form-item label="履约保证金金额（万元）" prop="margin" :rules="form.marginType == '1' ? rules.margin : [{ required: false }]">
                  <el-input v-model="form.margin" placeholder="请输入履约保证金"/>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <div v-if="form.chargemType=='2' || form.chargemType=='3'">
                <el-form-item label="固定差价(元)" prop="chargemGd">
                  <el-input v-model="form.chargemGd" placeholder="请输入固定差价"  @change="jsprice"/>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="预计单价(元)" prop="expectPrice">
                <el-input v-model="form.expectPrice" placeholder="请输入预计单价"   @change="jsprice"/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="预计重量(吨)" prop="expectWeight">
                <el-input v-model="form.expectWeight" placeholder="请输入预计重量"  @change="jsprice"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="成本年服务费费率(%)" prop="rateYear">
                <el-input v-model="form.rateYear" placeholder="请输入成本年服务费费率"   @change="jsprice"/>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="预计利润" prop="expectProfits">
                <el-input v-model="form.expectProfits" placeholder="请输入预计利润" />
              </el-form-item>
            </el-col>
          </el-row>
        </div>
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="公司名称" prop="shName">
                  <el-input v-model="form.shName" placeholder="请输入公司名称"  :rules="form.shType == '1' ? rules.shName : [{ required: false }]"/>
                </el-form-item>
              </el-col>

              <el-col :span="12">
                <el-form-item label="性质" prop="shXz">
                  <el-select v-model="form.shXz" style="width: 100%;" placeholder="请选择性质"  :rules="form.shType == '1' ? rules.shXz : [{ required: false }]">
                    <el-option
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="合作方式" prop="shHztype">
                  <el-select v-model="form.shHztype" style="width: 100%;" placeholder="请选择合作方式" :rules="form.shType == '1' ? rules.shHztype : [{ required: false }]">
                    <el-option
              ...
              <el-col :span="12">
                <div v-if="form.shHztype=='年息收取'">
                  <el-form-item label="资金费率%" prop="shHzrate">
                    <el-input v-model="form.shHzrate" placeholder="请输入资金费率"  :rules="form.shType == '1' ? rules.shHzrate : [{ required: false }]"/>
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="下游渠道" prop="shChanneltype">
                  <el-radio-group v-model="form.shChanneltype"  :rules="form.shType == '1' ? rules.shChanneltype : [{ required: false }]">
                    <el-radio label="1">有</el-radio>
                    <el-radio label="2">无</el-radio>
                  </el-radio-group>
                </el-form-item>
              ...
              <el-col :span="12">
                <div v-if="form.shChanneltype=='1'">
                  <el-form-item label="下游渠道年限" prop="shChannelyear">
                    <el-select v-model="form.shChannelyear" style="width: 100%;" placeholder="请选择下游渠道年限" :rules="form.shType == '1' ? rules.shChannelyear : [{ required: false }]">
                      <el-option
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="结算比例" prop="shSettlement">
                  <el-select v-model="form.shSettlement" style="width: 100%;" placeholder="请选择结算比例" :rules="form.shType == '1' ? rules.shSettlement : [{ required: false }]">
                    <el-option
              ...
              <div v-if="form.shSettlement=='其他'">
                <el-col :span="3" >
                  <el-form-item label="" prop="shSettlementA1"  label-width="10px">
                    <span><el-input v-model="form.shSettlementA1" placeholder="" style="width: 80%"/></span><span>%</span>
                  </el-form-item>
                </el-col>
                <el-col :span="3" >
                  <el-form-item label="" prop="shSettlementA2"  label-width="10px">
                    <span><el-input v-model="form.shSettlementA2" placeholder="" style="width: 80%"/></span><span>%</span>
                  </el-form-item>
                </el-col>
                <el-col :span="3" >
                  <el-form-item label="" prop="shSettlementA3"  label-width="10px">
                    <span><el-input v-model="form.shSettlementA3" placeholder="" style="width: 80%"/></span><span>%</span>
                  </el-form-item>
                </el-col>
              </div>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="履约保证金" prop="shMargintype">
                  <el-radio-group v-model="form.shMargintype"  :rules="form.shType == '1' ? rules.shMargintype : [{ required: false }]">
                    <el-radio label="1">有</el-radio>
                    <el-radio label="2">无</el-radio>
                  </el-radio-group>
                </el-form-item>
              ...
              <div v-if="form.shMargintype=='1'">
                <el-col :span="12">
                  <el-form-item label="履约保证金(元)" prop="shMargin">
                    <el-input v-model="form.shMargin" placeholder="请输入履约保证金"  :rules="form.shType == '1' ? rules.shMargin : [{ required: false }]"/>
                  </el-form-item>
                </el-col>
              </div>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="合同签署" prop="shContracttype">
                  <el-select v-model="form.shContracttype" style="width: 100%;" placeholder="请选择合同签署" :rules="form.shType == '1' ? rules.shContracttype : [{ required: false }]">
                    <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="终端客户名称" prop="terminalId">
                <el-select filterable value-key="terminalId" style="width: 100%;" @change="changeTerinal"  v-model="form.terminalId" placeholder="请选择终端客户">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="性质" prop="tXz">
                <el-select v-model="form.tXz" style="width: 100%;" placeholder="请选择性质">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="立户情况" prop="tAccount">
                <el-select v-model="form.tAccount" placeholder="请选择立户情况" style="width: 100%;">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="合作年限" prop="tCyear">
                <el-select v-model="form.tCyear" placeholder="请选择合作年限" style="width: 100%;">
                  <el-option
            ...
            <el-col :span="12">
              <div v-if="form.tTendertype=='1'">
                <el-form-item label="投标方式" prop="tTender">
                  <el-select v-model="form.tTender" placeholder="请选择投标方式" style="width: 100%;">
                    <el-option
            ...
            <el-col :span="12">
              <div v-if="form.tMargintype=='1'">
                <el-form-item label="投标保证金(万元)" prop="tMargin">
                  <el-input v-model="form.tMargin" placeholder="请输入投标保证金" />
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="保证金缴纳时间" prop="tMargintime">
                <el-select v-model="form.tMargintime" placeholder="请选择保证金缴纳时间" style="width: 100%;">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="合同签署" prop="tContracttype">
                <el-select v-model="form.tContracttype" placeholder="请选择合同签署" style="width: 100%;">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="运输方式" prop="tTransporttype">
                <el-select v-model="form.tTransporttype" placeholder="请选择运输方式" style="width: 100%;">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="发站" prop="tTransportstart">
                <el-input v-model="form.tTransportstart" placeholder="请输入发站" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="到站" prop="tTransportend">
                <el-input v-model="form.tTransportend" placeholder="请输入到站" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="到场数质确认时间" prop="tOktime">
                <el-select v-model="form.tOktime" placeholder="请选择到场数质确认时间" style="width: 100%;">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="到场数质确认方式" prop="tOktype">
                <el-select v-model="form.tOktype" placeholder="请选择到场数质确认方式" style="width: 100%;">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="开票结算方式" prop="tSettlementtype">
                <el-select v-model="form.tSettlementtype" placeholder="请选择开票结算方式" style="width: 100%;">
                  <el-option
            ...
            <el-col :span="12">
              <el-form-item label="结算规则" prop="tSettlementgz">
                <el-select v-model="form.tSettlementgz" placeholder="请选择结算规则" style="width: 100%;">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="回款账期" prop="tPaymentdays">
                <el-input v-model="form.tPaymentdays" placeholder="请输入回款账期" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="付款方式" prop="tPaymenttype">
                <el-select v-model="form.tPaymenttype" placeholder="请选择付款方式" style="width: 100%;">
                  <el-option
        ...
        <div style="margin-top: 50px;" v-if="active=='3' && isLook!=4">
          ...
          <div v-if="form.platformType=='1'">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="站台经营方式" prop="pJymode">
                  <el-select v-model="form.pJymode" placeholder="请选择站台经营方式" style="width: 100%;">
                    <el-option
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="站台发运方式" prop="pFymode">
                  <el-select v-model="form.pFymode" placeholder="请选择站台发运方式" style="width: 100%;">
                    <el-option
              ...
              <el-col :span="12">
                <div v-if="form.pFymode=='第三方代发'">
                  <el-form-item label="承运方发运名称" prop="pCname">
                    <el-input v-model="form.pCname" placeholder="请输入承运方发运名称" />
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
            <div v-if="form.pFymode!='独立立户'">
              <el-row>
                <el-col :span="12">
                  <el-form-item label="承运方性质" prop="pCxz">
                    <el-select v-model="form.pCxz" placeholder="请选择承运方性质" style="width: 100%;">
                      <el-option
                ...
                <el-col :span="12">
                  <el-form-item label="承运方发运年限" prop="pCyear">
                    <el-select v-model="form.pCyear" placeholder="请选择承运方发运年限" style="width: 100%;">
                      <el-option
              ...
              <el-row>
                <el-col :span="12">
                  <el-form-item label="承运方发运规模（万吨/年）" prop="pCnumber">
                    <el-input v-model="form.pCnumber" placeholder="请输入承运方发运规模" />
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="备注说明" prop="node">
                <el-input type="textarea" :rows="5" v-model="form.node" placeholder="请输入备注说明" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="说明" prop="node">
                <el-input type="textarea" :rows="5" v-model="form.xmNode" placeholder="请输入操作说明" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
export default {
    ...
    return {
      ...
      shHztypeOptions:
        [{"key":"固定差价买断","label":"固定差价买断"},
         {"key":"固定差价买断+承兑贴息调整","label":"固定差价买断+承兑贴息调整"},
         {"key":"年息收取","label":"年息收取"},
         {"key":"其他","label":"其他"}],
      //下游渠道年限
      ...
      rules: {
        ...
        userId: [
          { required: true, message: "请选择代办人", trigger: "blur" }
        ],
        supplierId: [
        ...
        tOktime: [
          { required: true, message: "请选择到场数质确认时间", trigger: "blur" }
        ],
        tOktype: [
          { required: true, message: "请选择到场数质确认方式", trigger: "blur" }
        ],
        tSettlementtype: [
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listSt(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('project/st/export', {
        ...this.queryParams
      }, `project_st.xlsx`)
    },
    next() {
    ...
    jsprice(){
      let arr=['cycleStart','cycleEnd','expectPrice','chargemNx','chargemGd','expectWeight']
      let valida_all=true
      this.$refs["form"].validateField(arr, valid => {
        if(valid){
          valida_all = valida_all && false;
