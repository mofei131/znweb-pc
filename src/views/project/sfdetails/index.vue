...
<!--          size="mini"-->
<!--          @click="handleExport"-->
<!--          v-hasPermi="['project:sfdetails:export']"-->
<!--        >导出</el-button>-->
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="sfdetailsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="付款金额(元)" align="center" prop="fPrice" />
      <el-table-column label="回款金额(元)" align="center" prop="hPrice" />
      <el-table-column label="资金占用余额(元)" align="center" prop="zPrice" />
    </el-table>
...
<script>
import { listSfdetails, getSfdetails, delSfdetails, addSfdetails, updateSfdetails } from "@/api/project/sfdetails";
