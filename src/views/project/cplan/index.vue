          ...
          <el-row>
            <el-col :span="24">
              ...
              >
                ...
                <el-table-column label="预计付款总额(元)">
                  <template slot-scope="scope">
                    <el-form-item
                      label-width="0"
                    ...
                    >
                      <el-input
                        ...
                        placeholder="请输入预计付款总额"
                      />
                    </el-form-item>
                  </template>
                </el-table-column>
                <el-table-column label="预计收款时间">
                  <template slot-scope="scope">
                    <el-form-item
                      label-width="0"
                ...
                <el-table-column label="预计收款总额(元)">
                  <template slot-scope="scope">
                    <el-form-item
                      label-width="0"
