...
<!--      </el-table-column>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="80%" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="180px">
        ...
        <el-row>
          <el-col :span="12">
            <el-button type="primary" @click="addTableData" style="margin-bottom: 30px;" v-if="isLook!=3">添加计划</el-button>
          </el-col>
        </el-row>
        <!--资金计划-->
          ...
          <el-row>
            <el-col :span="24">
              <el-table
                ...
                >
                  <template slot-scope="scope">
                    <el-form-item label-width="0"  :prop="'tableData.' + scope.$index + '.fkPrice'" :rules='rules.fkPrice'>
                      <el-input v-model="scope.row.fkPrice" placeholder="请输入预计付款总额"/>
                    </el-form-item>
                  </template>
                </el-table-column>
                <el-table-column
                ...
                >
                  <template slot-scope="scope">
                    <el-form-item label-width="0"  :prop="'tableData.' + scope.$index + '.skPrice'" :rules='rules.skPrice'>
                      <el-input v-model="scope.row.skPrice" placeholder="请输入预计收款总额"/>
                    </el-form-item>
                  </template>
                </el-table-column>
                <el-table-column
...
<script>
import { listCplan, getCplan, delCplan, addCplan, updateCplan, getStList,getUserList } from "@/api/project/cplan";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listCplan(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('project/cplan/export', {
        ...this.queryParams
      }, `project_cplan.xlsx`)
    },
