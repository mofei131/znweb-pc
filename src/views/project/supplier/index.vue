    ...
    <el-dialog :title="title" :visible.sync="open" width="80%" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="180px">
        ...
        <div v-if="form.sourcemType=='1'">
          <el-row>
            <el-col :span="12">
              <el-form-item label="原资方名称" prop="sourcemName" :rules="form.sourcemType == '1' ? rules.sourcemName : [{ required: false }]">
                <el-input v-model="form.sourcemName" placeholder="请输入原资方名称" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="原资方放款节点" prop="sourcemLn" :rules="form.sourcemType == '1' ? rules.sourcemLn : [{ required: false }]">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="原资方费率" prop="sourcemRate" :rules="form.sourcemType == '1' ? rules.sourcemRate : [{ required: false }]">
                <el-input v-model="form.sourcemRate" placeholder="请输入原资方费率" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="原资方放款比例" prop="sourcemLr" :rules="form.sourcemType == '1' ? rules.sourcemLr : [{ required: false }]">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      supplierList: [],
      // 供应商
      sourcemTypes: [{"key":1,"value":"是"},{"key":2,"value":"否"}],
      //审核状态集合
      stateOptions:[],
      // 弹出层标题
      title: "",
      ...
      rules: {
        ...
        sourcemLn: [
          { required: true, message: "原资方放款节点不能为空", trigger: "blur" }
        ],
        sourcemRate: [
          { required: true, message: "原资方费率不能为空", trigger: "blur" }
        ],
        sourcemLr: [
          { required: true, message: "原资方放款比例不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('project/supplier/export', {
        ...this.queryParams
