<template>
  <div class="app-container">
    <div>
      <div class="top">
        <el-form :model="doneListFrom" ref="ruleForm" :inline="true" label-width="80px">
          <el-form-item label="流程名称">
            <el-input v-model="doneListFrom.taskName" placeholder="请输入流程名称"></el-input>
          </el-form-item>
          <el-form-item label="流程类型">
            <el-select v-model="doneListFrom.approvalType" placeholder="请选择分类">
              <el-option v-for="dict in processTypeList" :key="dict.dictValue" :label="dict.dictLabel"
                :value="dict.dictValue"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="发起人">
            <el-input v-model="doneListFrom.initiatorUserName" placeholder="请输入发起人"></el-input>
          </el-form-item>
      ...
      <pagination v-show="total > 0" :total="total" :page.sync="doneListFrom.page" :limit.sync="doneListFrom.limit"
        @pagination="getList" />
    </div>
  </div>
</template>
