  ...
  <div>
    <el-form label-width="20px;" label-position="left">
      ...
      <el-row class="head-title">
        <el-col :span="19">
          <el-form-item label="发起人：">{{ queryParams.nickName }}</el-form-item>
        </el-col>
      </el-row>
    </el-form>
      ...
      <div v-if="initData.processType=='3'">
        <el-form label-width="20px;" label-position="left">
          ...
          <el-row class="head-text">
            ...
            <el-col :span="4" v-if="form.type=='煤炭采购合同'">
          ...
          <el-row class="head-text">
            <el-col :span="4" :offset="1">
              <el-form-item label="合计重量：" >
                <span  style="color: red;line-height: 57px !important;">{{form.totalWeight}}</span>
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item label="平均热值：" >
                <span  style="color: red;line-height: 57px !important;">{{form.averageRz}}</span>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row class="head-text">
            <el-col :span="4" :offset="1">
              <el-form-item label="已付金额：" >
                <span  style="color: red;line-height: 57px !important;">{{form.prepaidPrice}}</span>
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item label="实际付款金额：" >
                <span  style="color: red;line-height: 57px !important;">{{form.actualPrice}}</span>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row class="head-text" >
            <el-col :span="4" :offset="1">
              <el-form-item label="重量差">
                <span  style="color: red;line-height: 57px !important;" v-text="zlc"></span>
              </el-form-item>
            </el-col>
            <el-col :span="4">
            ...
            <el-col :span="4">
              <el-form-item label="单价差" prop="averageRz">
                <span  style="color: red;line-height: 57px !important;" v-text="djc"></span>
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item label="总额差" prop="averageRz">
                <span  style="color: red;line-height: 57px !important;" v-text="zec"></span>
              </el-form-item>
            </el-col>
          </el-row>
...
<script>
import { getProcessData, passed, turnDownByProcessId } from "@/api/approve/index.js";
