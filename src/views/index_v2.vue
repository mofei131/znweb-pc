  ...
  <div style="background-color: #f0f3f8">
    ...
    <div style="padding: 17px">
      <div style="display: flex; margin-bottom: 17px">
        <img style="height: 15px; width: 8px" src="../../public/img/bar.png" alt="" />
        <div style="line-height: 15px; margin-left: 5px">我的数据</div>
      </div>
      <div>
        <el-row :gutter="10">
          <el-col :span="3">
            <div @click="goToFqi" style="
                border-radius: 8px;
                width: 100%;
                height: 99px;
              ...
              <div style="width: 125px; height: 72px; display: flex">
                <div>
                  <div style="font-size: 30px; font-weight: 600; color: #333333">
                    {{ initiateTotal }}
                  </div>
                  <div style="margin-top: 10px; font-size: 14px">我发起的</div>
                </div>
                <img style="width: 56px; height: 56px; margin-left: 10px" src="../../public/img/faqi.png" alt="" />
              </div>
            </div>
          </el-col>
          <el-col :span="3">
            <div @click="goTowodaiban" style="
                border-radius: 8px;
                width: 100%;
                height: 99px;
                background-color: #ffffff;
              ...
              <div style="width: 125px; height: 72px; display: flex">
                ...
                <img style="width: 56px; height: 56px; margin-left: 10px" src="../../public/img/daiban.png" alt="" />
              </div>
            </div>
          </el-col>
          <el-col :span="3">
            <div @click="goTobudaiban" style="
                border-radius: 8px;
                width: 100%;
                height: 99px;
                background-color: #ffffff;
              ...
              <div style="width: 125px; height: 72px; display: flex">
                ...
                <img style="width: 56px; height: 56px; margin-left: 10px" src="../../public/img/bumen.png" alt="" />
              </div>
            </div>
          </el-col>
          <el-col :span="3">
            <div @click="goTochaosong" style="
                border-radius: 8px;
                width: 100%;
                height: 99px;
                background-color: #ffffff;
              ...
              <div style="width: 125px; height: 72px; display: flex">
                ...
                <img style="width: 56px; height: 56px; margin-left: 10px" src="../../public/img/chaosong.png" alt="" />
              </div>
            </div>
          </el-col>
          <el-col :span="4">
            <div style="position: relative">
              <img src="../../public/img/zi.png" style="width: 100%; height: 99px" alt="" />
              <div style="
                  position: absolute;
                  top: 0;
                  width: 100%;
                ...
                <div style="
                    ...
                    align-items: center;
                  ">
                  <div style="font-size: 1.5rem; font-weight: 400; color: #fbfdfd">
                    {{ sc.toFixed(2)
                        .toString()
          ...
          <el-col :span="4">
            <div style="position: relative">
              <img src="../../public/img/huang.png" style="width: 100%; height: 99px" alt="" />
              <div style="
                  position: absolute;
                  top: 0;
                  width: 100%;
          ...
          <el-col :span="4">
            <div style="position: relative">
              <img src="../../public/img/lan.png" style="width: 100%; height: 99px" alt="" />
              <div style="
                  position: absolute;
                  top: 0;
                  width: 100%;
      ...
      <el-row :gutter="10">
        <el-col :span="4">
          ...
          <div style="
            ...
            <div style="
                ...
                align-items: center;
              " @click="toSt">
              <img style="width: 34px; height: 32px" src="../../public/img/add.png" alt="" />
            ...
            <div style="
                ...
                align-items: center;
              " @click="toContract">
              <img style="width: 34px; height: 32px" src="../../public/img/hetong.png" alt="" />
            ...
            <div style="
                ...
                align-items: center;
              " @click="toApayment">
              <img style="width: 34px; height: 32px" src="../../public/img/yufukuan.png" alt="" />
            ...
            <div style="
                ...
                align-items: center;
              " @click="toFpayment">
              <img style="width: 34px; height: 32px" src="../../public/img/zuizhongfukuan.png" alt="" />
            ...
            <div style="
                ...
                align-items: center;
              " @click="toSk">
              <img style="width: 34px; height: 32px" src="../../public/img/shoukuan.png" alt="" />
            ...
            <div style="
                ...
                align-items: center;
              " @click="toDp">
              <img style="width: 34px; height: 32px" src="../../public/img/qijianfeiyong.png" alt="" />
        ...
        <el-col :span="10">
          ...
          <div style="
            ...
            ">
            <div>
              <el-date-picker v-model="value2" style="width:100px" type="year" placeholder="选择年" size="mini"
                @change="changeMouth">
              </el-date-picker>
            </div>
            <div id="chartA"></div>
          ...
          <div style="
            ...
            <div style="display: flex;position:absolute;right:20px">
              ...
              <el-date-picker v-model="dateRange2" style="width: 240px" value-format="yyyy-MM-dd" type="daterange"
                range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" size="mini"></el-date-picker>
              <div style="
                  width: 60px;
                  height: 26px;
                  background: #003088;
            ...
            <el-table style="margin-top:45px" :header-cell-style="{ background: '#F5F7FB' }" v-loading="loading2"
              size="mini" :data="cplanList" fit>
            ...
            <pagination5 v-show="total4 > 0" :total="total4" :page.sync="queryParams4.pageNum"
              :limit.sync="queryParams4.pageSize" @pagination="getList4" />
          </div>
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="11">
          ...
          <div style="
              ...
              padding: 20px;
            ">
            <el-table v-loading="loading3" :header-cell-style="{ background: '#F5F7FB' }" :data="stList" size="mini"
              fit>
            ...
            <pagination5 v-show="total3 > 0" :total="total3" :page.sync="queryParams3.pageNum"
        ...
        <el-col :span="13">
          ...
          <div style="
            ...
            <el-table style="margin-top:45px" :header-cell-style="{ background: '#F5F7FB' }" v-loading="loading"
              :data="ptakeupList" size="mini" fit>
              <el-table-column label="项目名称" align="center" width="220" prop="stName" />
              <el-table-column label="立项时间" align="center" prop="createTime" width="100">
                <template slot-scope="scope">
                  <span>{{
                      parseTime(scope.row.createTime, "{y}-{m}-{d}")
                  }}</span>
            ...
            <pagination5 v-show="total2 > 0" :total="total2" :page.sync="queryParams2.pageNum"
