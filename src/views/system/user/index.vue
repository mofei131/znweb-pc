        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item  label="账号" prop="userName">
              <el-input v-model="form.userName" placeholder="请输入账号" maxlength="30" :disabled="this.title == '修改用户'"/>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="电话" prop="phonenumber">
              <el-input v-model="form.phonenumber" placeholder="请输入电话" maxlength="11" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<!--          </el-col>-->
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="用户代码" prop="remark">
              <!-- :disabled="this.title == '修改用户'" -->
              <el-input v-model="form.remark"  placeholder="请输入用户代码" ></el-input>
            </el-form-item>
          </el-col>
<!--          <el-col :span="24">-->
