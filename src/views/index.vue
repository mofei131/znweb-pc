    ...
    <div style="display:flex;padding:20px;box-sizing: border-box;">
      <div style="width:40%;">
        <div style="display:flex">
          <div
            style="border-radius:6px;width:70%;height:128px;background-color:#ffffff;margin-right:10px;padding:10px;box-sizing:bpx-sizing;">
          ...
          <div style="border-radius:6px;width:30%;height:128px;background-color:#ffffff;padding:10px">
            <div style="font-weight:600;font-size: 14px;">我的数据</div>
        ...
        <div style="background-color:#ffffff;height:288px;margin-top:10px;border-radius:6px">
          <div style="display:flex;justify-content: space-between;padding:10px">
            <div style="font-weight:600;font-size: 14px;">营业利润</div>
            <div>
              <el-date-picker v-model="value1show" style="width:100px" type="year" placeholder="选择年" size="mini"
                @change="changeYear1">
              </el-date-picker>
...
export default {
  ...
  mounted() {
    taskTodo().then((res) => {
      if (res.rows.length > 0) {
        this.tongzhi = res.rows[0].taskName
      } else {
        this.tongzhi = "暂无通知"
      }
    });
  ...
  methods: {
    ...
    myEchartsB() {
      ...
      const chartB = this.$echarts.init(chartDom)
      chartB.setOption({
        series: [
          {
            type: 'pie',
            ...
            radius: [30, 100],
            roseType: 'radius' //南丁格尔图 饼图的每个半径的区域是不同的
          }
        ]
      })
    },
    myEchartsC() {
      ...
      const chartC = this.$echarts.init(chartDom)
      chartC.setOption({
        series: [
          {
            type: 'pie',
    ...
    myEchartsD() {
      ...
      var toolTipData = [
        ...
        },
        {
          name: '山西',
          value: [
            { name: '晋北基地是我国特大型动力煤基地', value: 4 },
            { name: '是我国重要的优质动力煤生产基地', value: 90 },
            { name: '晋中基地地处山西省中部及中西部', value: 4 },
            { name: '煤炭可采储量192亿吨', value: 90 },
            { name: '晋东基地是我国最大和最重要的优质无烟煤生产基地', value: 4 },
          ],
        },
        {
          name: '内蒙古',
          value: [
            { name: '东北亿顿级煤炭基地', value: 10 },
            { name: '煤炭储量900多亿吨', value: 10 },
            { name: '神东基地以神府、东胜矿区为主，煤炭储量达1349.4亿吨', value: 10 },
            { name: '是我国规模较大的优质造气动力煤田', value: 10 }
          ],
        },
        {
          name: '辽宁',
        ...
        },
        {
          name: '安徽',
          value: [
            { name: '两淮基地包括淮南、淮北矿区', value: 8 },
            { name: '煤炭年产量达1.5亿吨', value: 8 },
          ],
        },
        {
          name: '福建'
        ...
        },
        {
          name: '山东',
          value: [
            { name: '鲁西亿吨级煤炭基地', value: 5399 },
            { name: '煤炭储备量160多吨', value: 5399 }
          ],
        },
        {
          name: '河南',
          value: [
            { name: '河南亿吨级煤炭基地', value: 12 },
            { name: '煤炭储备量1100多亿吨', value: 71 },
          ],
        },
        {
          name: '湖北'
        ...
        },
        {
          name: '贵州',
          value: [
            { name: '云贵两省是我国南方重要的煤炭生产基地', value: 8 },
            { name: '煤炭储量超400亿吨', value: 8 }
          ],
        },
        {
          name: '云南',
        ...
        },
        {
          name: '陕西',
          value: [
            { name: '陕北亿吨级煤炭基地', value: 8 },
            { name: '煤炭储备300多亿吨', value: 8 },
            { name: '黄陇亿吨级煤炭基地', value: 8 },
            { name: '煤炭储备150多亿吨，年产量2000多万吨', value: 8 },
          ],
        },
        {
          name: '甘肃'
        ...
        },
        {
          name: '宁夏',
          value: [
            { name: '宁东能源重化工基地', value: 8 },
            { name: '优质无烟煤储量270多亿吨', value: 8 },
          ],
        },
        {
          name: '新疆'
